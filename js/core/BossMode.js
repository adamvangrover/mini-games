...
export default class BossMode {
    ...
    toastLocked(name) {
        window.miniGameHub.showToast(`${name} Required. Purchase from Store.`);
    }
    ...
    renderIcons() {
        ...
        const icons = [
            ...
            { name: "Spicy Market", icon: "fas fa-shopping-bag", color: "text-red-500", action: "marketplace" },
            { name: "Grok Chat", icon: "fas fa-brain", color: "text-purple-400", action: "grok" },
