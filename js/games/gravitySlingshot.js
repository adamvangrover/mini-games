            ...
            <div class="relative w-full h-full bg-black overflow-hidden font-mono select-none" id="gravitySlingshot-ui">
                ...
                <div class="absolute inset-0 flex items-center justify-center text-white z-10 pointer-events-none">
                    <div class="text-center bg-black/80 p-6 rounded-xl border border-fuchsia-500 shadow-[0_0_15px_rgba(217,70,239,0.5)]">
                        <h1 class="text-3xl font-bold text-cyan-400 mb-2">Gravity Slingshot</h1>
                        <p class="text-slate-300 max-w-md">An orbital mechanics puzzle using N-body gravitational physics.</p>
